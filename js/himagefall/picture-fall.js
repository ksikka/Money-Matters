...
var image="js/himagefall/dolla.png";  //Image path should be given here
...
for (i = 0; i < no; ++ i) {  
	...
	document.write("<div class=\"fallmoney\" id=\"dot"+ i +"\" style=\"POSITION: absolute; Z-INDEX: "+ (i+5) +"; VISIBILITY: visible; TOP: 15px;LEFT: 15px;\"><img src='"+image+"' style=\"border:0px\"border=\"0\"><\/div>");
}
